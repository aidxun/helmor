	...
	return (
		...
		>
			...
			<CapabilityToggle
				...
				description="Allow Helmor to execute code and create and edit docs, spreadsheets, presentations, PDFs, and data reports."
				value={codeExecution}
			...
			<CapabilityToggle
				icon={Globe}
				label="Web search"
				description="Helmor will automatically search the web when it determines it needs current information"
				value={webSearch}
			...
			<CapabilityToggle
				...
				description="Allow Helmor to search for relevant details in past sessions. Learn more."
				value={searchChats}
			...
			<CapabilityToggle
				...
				description="Allow Helmor to remember relevant context from your sessions. This setting controls memory for both sessions and projects. Learn more."
			...
			<View className="mx-5 mt-4 bg-muted rounded-xl px-4 py-3.5 flex-row items-center border-continuous">
				<View className="flex-1">
					...
					<Text className="text-[13px] text-muted-foreground mt-0.5">
						Updated 4d ago from your sessions
					</Text>
				</View>
				<Icon
					icon={ChevronRight}
			...
			<ToolAccessOption
				label="Auto"
				description="Helmor chooses for you"
				selected
			/>
			<ToolAccessOption
				label="On demand"
