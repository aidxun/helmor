...
export default function ProfileScreen() {
	const [fullName, setFullName] = useState("Helmor User");
	const [nickname, setNickname] = useState("Helmor");
	const [preferences, setPreferences] = useState(
		"I use Helmor to manage local workspaces and agent sessions.",
	);
	...
	return (
		...
		>
			...
			<Text className="text-[13px] text-muted-foreground mt-2 leading-relaxed">
				Your preferences will apply to all conversations, within Helmor
				guidelines.
			</Text>
