...
import { MobileSettingsProvider } from "@/lib/mobile-settings";
				...
				<WorkspaceProvider>
					<View className="flex h-dvh w-full flex-row bg-sidebar">
						...
						<View className="flex min-w-0 flex-1 flex-col">
							...
							{/* Inset content panel */}
							<View className="flex min-h-0 flex-1 flex-col overflow-hidden bg-background md:rounded-tl-xl md:border-t md:border-l md:border-border/40">
								<Slot />
							</View>
						</View>
					</View>
